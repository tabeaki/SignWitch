     ...
     return <header>
            <nav className="max-w-full bg-black">
                ...
                <div className='justify-end flex'>
                    <div className="px-2 text-center text-sm lg:text-2xl pt-3 text-white font-semibold "><a  href="/">Home</a></div>
                    <div className="px-2 text-center text-sm lg:text-2xl pt-3 text-white font-semibold "><a  href="/gallery">Gallery</a></div>
